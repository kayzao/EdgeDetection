...
int BRC_port = 10002;
int BRC_WebBodySize = 7728;

String[] BRC_ids = new String[] {"file","load","threshold","horizontal","vertical","omni","camera"};
String[] BRC_values = new String[] {"h","0","35","0","0","0","false"};
...
+ "*/\n"
+ "\n"
+ "const Controls=[[\"NOTE\",\"brc_1\",\"intro\"],\n"
+ "[\"DROPDOWN\",\"brc_2\",\"file\"],\n"
+ "[\"BUTTON\",\"brc_3\",\"load\"],\n"
+ "[\"RANGE\",\"brc_4\",\"threshold\",\"brc_5\"],\n"
+ "[\"BUTTON\",\"brc_6\",\"horizontal\"],\n"
+ "[\"BUTTON\",\"brc_7\",\"vertical\"],\n"
+ "[\"BUTTON\",\"brc_8\",\"omni\"],\n"
+ "[\"CHECKBOX\",\"brc_9\",\"camera\"]];\n"
+ "\n"
+ "Monitor = false;\n"
+ "\n"
+ "function Sendall() {\n"
...
+ "\n"
+ "<br/>\n"
+ "<table><tr><td class=\"auto-style1\"><label id=\"brc_1\">Edge Detection</label></td></tr></table>\n"
+ "\n"
...
+ "</select></td></tr></table>\n"
+ "\n"
+ "<input type=\"button\" name=\"<!--<id>-->\" id=\"<!--<id>-->\" value=\"Load\" onClick=\"SendNameValue('load='+Math.floor(Math.random()*1000000));\" />\n"
+ "&nbsp;&nbsp;&nbsp;\n"
+ "\n"
+ " <table ><tr><td class=\"auto-style1\">0  \n"
+ "    <input type=\"range\" id=\"brc_4\" name=\"brc_4\" min=\"0\" max=\"255\" value=\"35\" step=\"1\"\n"
+ "    oninput=\"ShowRange('brc_4','brc_5','threshold');\" />  255<br/>\n"
+ "    Threshold: <label id=\"brc_5\"></label>\n"
+ "    </td></tr></table>\n"
+ "\n"
+ "<input type=\"button\" name=\"<!--<id>-->\" id=\"<!--<id>-->\" value=\"Horizontal edges\" onClick=\"SendNameValue('horizontal='+Math.floor(Math.random()*1000000));\" />\n"
+ "&nbsp;&nbsp;&nbsp;\n"
+ "\n"
+ " <input type=\"button\" name=\"<!--<id>-->\" id=\"<!--<id>-->\" value=\"Vertical edges\" onClick=\"SendNameValue('vertical='+Math.floor(Math.random()*1000000));\" />\n"
+ "&nbsp;&nbsp;&nbsp;\n"
+ "\n"
+ " <input type=\"button\" name=\"<!--<id>-->\" id=\"<!--<id>-->\" value=\"Omni-directional\" onClick=\"SendNameValue('omni='+Math.floor(Math.random()*1000000));\" />\n"
+ "&nbsp;&nbsp;&nbsp;\n"
+ "\n"
+ " <table ><tr><td class=\"auto-style1\">\n"
+ "Show camera?:  <input name=\"brc_9\" type=\"checkbox\"  id=\"brc_9\" onclick=\"SendCheckbox('brc_9','camera');\"/> \n"
+ "</td></tr></table>\n"
+ "\n"
+ "\n"
+ "\n"
